...
test.describe('Verify Edit Payment Terms API', () => {
  ...
  test('TC-PAY-01 | Verify edit payment details with valid details', async ({ request }) => {
  ...
  test('TC-PAY-03 | Verify edit payment details with missing credit limit', async ({ request }) => {
